function [Child_1, Child_2] = SBX_Swap(Chrom,Chrom_Length,Cap,Function_Number,X)
...
while flag_1||flag_2
    ...
    flag_2 = Judge(Child_2,Chrom_Length,Target_Demand,Cap);
end
